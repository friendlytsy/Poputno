...
btn_pp_3 = InlineKeyboardButton(text = '№3', callback_data='№3 Шале')
btn_pp_4 = InlineKeyboardButton(text = '№4 Ривьера', callback_data='№4 Ривьера')
btn_pp_5 = InlineKeyboardButton(text = '№5', callback_data='№5 Шале')
btn_pp_6 = InlineKeyboardButton(text = '№6 ', callback_data='№6 Шале')
